function err=aviso_load_cmems_product_med(day0,dayf,path_to_product,wrk_dir)
...
dayvec=dayvec(1:3);
[Udegs,Vdegs,lonw,latw]=getncUV_aviso_cmems_product_med(path_to_product,dayvec,wrk_dir);
if(isempty(Udegs))
