...
%            slen      = vector containing the length of the resulting segments. 
%
...
% 
%            Need some coastline data?  Try out the coastline extractor at:
%
%                  http://crusty.er.usgs.gov/getcoast.html
%
